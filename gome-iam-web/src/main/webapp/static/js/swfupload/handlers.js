...
function Ok() {
	...
	// if ( oEditor.FCK.EditMode == FCK_EDITMODE_WYSIWYG )
	// oEditor.FCK.SetHTML(allurl);
	return true;
...
function queueComplete(numFilesUploaded) {
	...
	status.innerHTML = numFilesUploaded + " 鏂囦欢"
			+ (numFilesUploaded === 1 ? "" : "") + " 宸茬粡涓婁紶.";
