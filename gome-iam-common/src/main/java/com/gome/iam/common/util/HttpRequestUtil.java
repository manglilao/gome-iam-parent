...
public class HttpRequestUtil {
    ...
    public static void close(OutputStreamWriter outputStreamWriter, OutputStream outputStream,
                             BufferedReader reader, InputStreamReader inputStreamReader, InputStream inputStream) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
        ...
        header.put("from", "sso");
        System.out.println(HttpRequestUtil.doDelete("http://10.128.31.72:8000/relay/user/deleteuser"+"/123456"+"/yanqing-kg/"));
//        System.out.println(HttpRequestUtil.doDelete("http://127.0.0.1:8080/app/test", body));
//        System.out.println(HttpRequestUtil.doDelete("http://127.0.0.1:8080/app/test/111/yintong/"));
//        System.out.println(HttpRequestUtil.doPut("http://127.0.0.1:8080/app/test", JSON.toJSONString(body)));
//        System.out.println(HttpRequestUtil.doPost("http://10.128.31.72:8000/relay/apiapi/?method=update_out_user_passwd", body));
    }
}
